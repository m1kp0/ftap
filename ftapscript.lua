--- хахаха опен сурс скрипт омагод пиздите сколько хотите он хуйня
...
local bringedPlayerNameLeft = nil
local bringedPlayerNameRight = nil
local chatByapasEn
local sund
local antiBanana
enabledSpy = false
...
if model.Name == "Part" and game.Players.LocalPlayer.Character and antiexpl then
		local mag = (model.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
		if mag <= 18 then
			anch_plr()
		end
	end
...
if blobalter == 1 then
    ...
    blobman.BlobmanSeatAndOwnerScript.CreatureGrab:FireServer(unpack(args))
    blobalter = 2
else
    local args = {
...
local ChatTab = Window:MakeTab({Name = "Chat", Icon = "", PremiumOnly = false})
...
Callback = function(Value)
	...
	if CrazyGrabCoroutine then
		...
		if a then
		    for _, i in pairs(a:GetChildren()) do
			if i.Name == "heavenTORS" and i:IsA("BodyVelocuty") then i:Destroy() end
		    end
		end
	    end
	end
...
Color = Color3.fromRGB(102, 0, 102),
Save = true,
Flag = "AntiBananaRagdoll",
Callback = function(enabled)
    antiBanana = enabled
    workspace.DescendantAdded:Connect(function(thing)
	if thing.Name == 'BananaPeel' and antiBanana then
	    while antiBanana do
		wait()
		if thing then
...
ChatTab:AddToggle({
    ...
    sund = Value
		while sund do
	game:GetService("Players"):Chat("haha")
	wait(0.1)
	game:GetService("Players"):Chat("dead")
	wait(0.1)
	game:GetService("Players"):Chat("grab")
	wait(0.1)
	game:GetService("Players"):Chat("fly")
	wait(0.1)
	game:GetService("Players"):Chat("1")
	wait(0.1)
	game:GetService("Players"):Chat("2")
	wait(0.1)
	game:GetService("Players"):Chat("3")
	wait(0.1)
	game:GetService("Players"):Chat("4")
	wait(0.1)
	game:GetService("Players"):Chat("5")
	wait(0.1)
	game:GetService("Players"):Chat("Hello")
	wait(0.1)
	game:GetService("Players"):Chat("lick")
	wait(0.1)
	game:GetService("Players"):Chat("aaa")
	wait(0.1)
	game:GetService("Players"):Chat("ooo")
	wait(0.1)
	game:GetService("Players"):Chat("ew")
	wait(0.1)
	game:GetService("Players"):Chat("shh")
	wait(0.1)
	game:GetService("Players"):Chat("yeehaw")
	wait(0.1)
	game:GetService("Players"):Chat("burp")
	wait(0.1)
	game:GetService("Players"):Chat("sneeze")
	wait(0.1)
	game:GetService("Players"):Chat("sick")
	wait(0.1)
	game:GetService("Players"):Chat("ahem")
	wait(0.1)
	game:GetService("Players"):Chat("nom")
	wait(0.1)
	game:GetService("Players"):Chat("grrr")
	wait(0.1)
	game:GetService("Players"):Chat("banana")
	wait(0.1)
	game:GetService("Players"):Chat("gun")
	wait(0.1)
	game:GetService("Players"):Chat("mama")
	wait(0.1)
	game:GetService("Players"):Chat("papa")
	wait(0.1)
	game:GetService("Players"):Chat("sing")
	wait(0.1)
	game:GetService("Players"):Chat("cry")
	wait(0.1)
	game:GetService("Players"):Chat("reee")
    end
	end    
})
...
Callback = function(Value)
	...
	for i, b in pairs(workspace:GetDescendants()) do
	    if b.Name == "BombMissle" then
		s = v.."SpawnedInToys"
		while Value do
		    wait(0.1)
		    SetNetworkOwner:FireServer(v.Body, v.Body.CFrame)
		    local args = {
			[1] = {
			    ["Radius"] = 17.5,
			    ["TimeLength"] = 0.5,
			    ["Hitbox"] = workspace:FindFirstChild(s).BombMissile.PartHitDetector,
			    ["ExplodesByFire"] = true,
			    ["MaxForcePerStudSquared"] = 225,
			    ["DestroysModel"] = true,
			    ["Model"] = workspace:FindFirstChild(s).BombMissile,
			    ["ExplodesByPointy"] = false,
			    ["ImpactSpeed"] = 20,
			    ["PositionPart"] = workspace:FindFirstChild(s).BombMissile.Body
			},
			[2] = Vector3.new(0,0,0)
		    }
...
Callback = function()
    if LeftBlobSelected then
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position.X, game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Y + 50, game.Players.LocalPlayer.Character.HumanoidRootPart.Position.X)

	bringLeft(LeftBlobSelected)
	task.wait(0.5)

	local args = {
	    workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("LeftDetector"):WaitForChild("LeftWeld"),
	    game:GetService("Players"):WaitForChild(LeftBlobSelected).Character:WaitForChild("HumanoidRootPart")
	}
	workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("BlobmanSeatAndOwnerScript"):WaitForChild("CreatureDrop"):FireServer(unpack(args))
...
Callback = function()
	...
	local args = {
	    workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("RightDetector"):WaitForChild("RightWeld"),
	    game:GetService("Players"):WaitForChild(RightBlobSelected).Character:WaitForChild("HumanoidRootPart")
	}
	workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("BlobmanSeatAndOwnerScript"):WaitForChild("CreatureDrop"):FireServer(unpack(args))
...
Callback = function()
	...
	local args = {
	    workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("LeftDetector"):WaitForChild("LeftWeld"),
	    game:GetService("Players"):WaitForChild(DuoBlobSelected).Character:WaitForChild("HumanoidRootPart")
	}
	workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("BlobmanSeatAndOwnerScript"):WaitForChild("CreatureDrop"):FireServer(unpack(args))
...
Color = Color3.fromRGB(102, 0, 102),
Callback = function(enabled)
    blobmanCoroutine = enabled
    while blobmanCoroutine do
	for i, v in pairs(game.Players:GetPlayers()) do
	    bringLeft(v)
	    local args = {
		workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("LeftDetector"):WaitForChild("LeftWeld"),
		game:GetService("Players"):WaitForChild(v).Character:WaitForChild("HumanoidRootPart")
	    }
	    workspace:WaitForChild(game.Players.LocalPlayer.Name.."SpawnedInToys"):WaitForChild("CreatureBlobman"):WaitForChild("BlobmanSeatAndOwnerScript"):WaitForChild("CreatureDrop"):FireServer(unpack(args))
	    task.wait(0.1)
	end
